...
class CCD_Rules: CCD_RscButton
{
	...
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); ExecVM 'scripts\Menu\RulesInit.sqf';";
};
...
{//55615
	...
	h = 0.0239398 * safezoneH;
	colorBackground[] = {0.176,0.329,0.564,0.8};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); groupManagementActive = false; [] execVM 'scripts\dzgm\loadGroupManagement.sqf';";
};
class CCD_EarPlugs: CCD_RscButton
{
	...
	h = 0.0239398 * safezoneH;
	colorBackground[] = {0.176,0.329,0.564,0.8};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); ExecVM 'scripts\Menu\scripts\Earplugs.sqf';";
};
class CCD_Suicide: CCD_RscButton
{
	...
	h = 0.0239398 * safezoneH;
	colorBackground[] = {0.176,0.329,0.564,0.8};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); ExecVM 'scripts\Menu\SuicideInit.sqf';";
};
...
class CCD_Motorbike: CCD_RscButton
{
	...
	h = 0.0239398 * safezoneH;
	colorBackground[] = {0.176,0.329,0.564,0.8};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); ['TT650_Civ'] execVM 'scripts\deploy\EVD\EVD_deploy.sqf';";
};
class CCD_Mozzie: CCD_RscButton
{
	...
	h = 0.0239398 * safezoneH;
	colorBackground[] = {0.176,0.329,0.564,0.8};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); ['CSJ_GyroC'] execVM 'scripts\deploy\EVD\EVD_deploy.sqf';";
};
class CCD_Bike: CCD_RscButton
{
	...
	h = 0.0239398 * safezoneH;
	colorBackground[] = {0.176,0.329,0.564,0.8};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 845167); execVM 'scripts\Menu\scripts\deploy.sqf';";
};
