...
_role1names = ["Undead Brasil"];
_role2 = "Admins";
_role2names = ["Mateuus", "Hailori", "Aquiles"];
_role3 = "Moderadores";
_role3names = ["Vagas abertas..."];
...
_role5 = "Server Mods";
_role5names = ["Advanced Trader", "Self-bb", "Custom traders", "etc..."];
_role6 = "Website";
_role6names = ["www.undeadbrasil.com"];
_role7 = "Forum";
_role7names = ["www.undeadbrasil.com/forum"];
_role8 = "TeamSpeak 3";
_role8names = ["ts3.undeadbrasil.com"];
_role9 = "Host";
_role9names = ["Undead Brasil Servidores"];
